...
public function __construct()
{
    ...
    $this->load->database();
    $this->load->model('user_analyse/User_anlyse_model');
}
...
{
    $url = 'http://' . $_SERVER['SERVER_NAME'] . '/SparkManagement/index.php/user_analyse/User_analyse/info_data1';
    ...
    $data['api_url'] = $url;
    $urlnew='http://' . $_SERVER['SERVER_NAME'] . '/SparkManagement/index.php/user_analyse/User_analyse/info_data?start_date='.date('Ymd',strtotime('- 15 day' )) .'&end_date='.date('Ymd',strtotime('- 8 day' ));
    $urlnew1='http://' . $_SERVER['SERVER_NAME'] . '/SparkManagement/index.php/user_analyse/User_analyse/info_data?start_date='.date('Ymd',strtotime('- 23 day' )) .'&end_date='.date('Ymd',strtotime('- 16 day' ));
    $data['urlnew']=$urlnew;
    ...
    $this->load->view('user_analyse/user_analyse',$data);
...
{
    $url = 'http://' . $_SERVER['SERVER_NAME'] . '/SparkManagement/index.php/user_analyse/User_analyse/info_chart1';
    ...
    $data['api_url'] = $url;
    $this->load->view('user_analyse/user_increment',$data);
