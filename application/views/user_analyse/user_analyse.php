...
<script src="/SparkManagement/assets/js/user_management/spark_user.js" xmlns:v-on="http://www.w3.org/1999/xhtml"
        xmlns:v-on="http://www.w3.org/1999/xhtml"></script>
<div class="content">
    <div class="second-nav">
        <ul class="nav nav-pills">
            <li class="active"><a href="/SparkManagement/index.php/user_analyse/User_analyse/info_data">用户增长</a></li>
            <li class=""><a href="/SparkManagement/index.php/user_analyse/User_analyse/info_chart">折线图</a></li>
            <li><a href="#">活跃用户</a></li>
            <li><a href="#">用户画像</a></li>
        </ul>
    </div>
