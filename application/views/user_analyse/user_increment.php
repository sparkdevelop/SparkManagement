...
<div class="content">
    <div class="second-nav">
        <ul class="nav nav-pills">
            <li><a href="/SparkManagement/index.php/user_analyse/User_analyse/info_data">用户增长</a></li>
            <li class="active"><a href="/SparkManagement/index.php/user_analyse/User_analyse/info_chart">折线图</a></li>
            <li><a href="#">活跃用户</a></li>
            <li><a href="#">用户画像</a></li>
        </ul>
    </div>
    ...
    <div id="start_date" name="start_date" style="display:none"><?php echo date('Y-m-d',strtotime('-1 day' ))?></div>
    <div id="end_date" name="end_date" style="display:none"><?php echo date('Y-m-d',strtotime('-7 day' ))?></div>
    ...
    <script src="/SparkManagement/assets/js/user_analyse/user_increment.js"></script>
