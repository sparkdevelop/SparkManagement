...
<div class="content">
    ...
    <div class="clearfix">
        ...
        <div class="" style="background-color: #ffffff ;text-align:center;width: 250px;height: 150px;display: block;float: left;padding-top: 34px"><span class="" style="font-size: 36px">120</span><br/><span class="">新增用户数</span></div>


        <i class="fa fa-users fa-4x user" style="color: white;text-align: center ; padding-top: 45px;float: left; margin-left: 5px"></i>
        <div class="" style="background-color:#ffffff ;text-align:center;width: 250px;height: 150px;display: block;float: left;padding-top: 34px"><span class="" style="font-size: 36px">85</span><br/><span class="">总用户数</span></div>
