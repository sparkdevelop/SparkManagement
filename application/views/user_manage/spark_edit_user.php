...
<script src="/SparkManagement/assets/js/user_manage/spark_edit_user.js"></script>
<div class="content">
    <div class="second-nav">
        <ul class="nav nav-pills">
            <li><a href="/SparkManagement/index.php/user_manage/User_list" target="_blank">所有用户</a></li>
